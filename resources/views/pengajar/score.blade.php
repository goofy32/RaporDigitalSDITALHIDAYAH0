        ...
        <div class="flex flex-col gap-2">
            ...
            @elseif($incompletePembelajaranCount > 0)
                <div class="inline-flex max-w-2xl items-start gap-2 rounded-lg border border-yellow-200 bg-yellow-50 px-3 py-2 text-sm text-yellow-800">
                    ...
                    <span>{{ $readyPembelajaranCount }} pembelajaran siap diunduh melalui Download Template Nilai. {{ $incompletePembelajaranCount }} pembelajaran belum lengkap, sehingga Download Semua Template Siap belum bisa digunakan. Lengkapi Tujuan Pembelajaran terlebih dahulu.</span>
                </div>
            @endif
        </div>
