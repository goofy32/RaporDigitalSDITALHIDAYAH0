                ...
                @foreach($students as $index => $student)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 border text-center">
                            ...
                            @else
                                <span class="inline-flex items-center justify-center rounded-full bg-gray-100 px-2 py-1 text-xs font-medium text-gray-500">
                                    Belum Lengkap
                                </span>
                            @endif
                        </td>
                    ...
                    foreach($mataPelajaran->lingkupMateris as $lm) {
                        foreach($lm->tujuanPembelajarans as $tp) {
                            ...
                            if ($nilaiTP !== null && $nilaiTP !== '' && $nilaiTP < $kkmValue) {
                                $needRemedial = true;
                                $belowKkmValues[] = "TP {$tp->display_kode_tp}: {$nilaiTP}";
                            }
                        }
                    }
