...
function mountNotificationHandler() {
    ...
    Alpine.data('notificationHandler', () => ({
        ...
        init() {
            this.$store.notification.bootstrap();
        },
...
export function registerNotificationHandler() {
    if (window.Alpine && window.alpineInitialized) {
        mountNotificationHandler();
        return;
    }

    document.addEventListener('alpine:init', mountNotificationHandler, { once: true });
}
