...
class ReportController extends Controller
{
    ...
    public function upload(Request $request)
    {
        ...
        try {
            ...
            if ($typeValidationMessage = $this->validateTemplateTypeFromDocxText($templatePath, $request->type)) {
    ...
    private function validateTemplateTypeFromDocxText(string $templatePath, string $type): ?string
    {
        try {
    ...
    private function extractDocxText(string $templatePath): string
    {
        $zip = new \ZipArchive();
